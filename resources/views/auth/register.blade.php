                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text" class="form-control input-circle{{ $errors->has('last_name') ? ' is-invalid' : '' }}" name="last_name" value="{{ session('user') ? session('user.last_name') : old('last_name') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control input-circle{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ session('user') ? session('user.email') :  old('email') }}" required>
