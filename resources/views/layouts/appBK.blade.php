...
<head>
    ...
    <script src="{{ asset('assets/layout5/scripts/layout.min.js') }}" defer></script>
    ...
    <link href="{{ asset('layout5/css/layout.min.css') }}" rel="stylesheet">
    <link href="{{ asset('layout5/css/custom.min.css') }}" rel="stylesheet">
</head>
<body>
    <div id="app">
